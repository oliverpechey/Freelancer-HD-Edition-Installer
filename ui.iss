...
var 
  ...
  txtAuto: String;
begin
  txtAa := 'Multisample Anti-Aliasing';
  ...
  descAdvancedAudioOptions.Top := descRegeneratableShields.Top + ScaleY(80);
  ...
  AdvancedAudioOptions.Top := descRegeneratableShields.Top + ScaleY(60);
