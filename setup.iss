    ...
    begin
        ...
        begin
          ...
          if DxWrapperGraphicsApi.Checked and DxWrapperReShade.Checked then
            SetWineDllOverride('d3d9')
          else if DgVoodooGraphicsApi.Checked and DgVoodooReShade.Checked then
            SetWineDllOverride('dxgi');
        end;
...
begin
    ...
    if (PageId = DgVoodooPage.ID) and (GpuManufacturer = AMDOrOther) then
    begin
